...
/***/ function(module, exports, __webpack_require__) {
	...
	var appModel_1 = __webpack_require__(263);
	var x_large_1 = __webpack_require__(264);
	var home_1 = __webpack_require__(265);
	var champions_1 = __webpack_require__(269);
	var roles_1 = __webpack_require__(273);
	var dates_1 = __webpack_require__(275);
	var App = (function () {
	    function App(app) {
	        this.app = app;
	    }
	    App = __decorate([
	        ...
	        router_1.RouteConfig([
	            ...
	            { path: '/:summoner/roles', component: roles_1.Roles, name: 'Roles' },
	            { path: '/:summoner/champions', component: champions_1.Champions, name: 'Champions' },
	            { path: '/:summoner/dates', component: dates_1.Dates, name: 'Dates' }
	        ]), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(22);
	var common_1 = __webpack_require__(121);
	var matchListService_1 = __webpack_require__(266);
	var appModel_1 = __webpack_require__(263);
	var Home = (function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var matchListService_1 = __webpack_require__(266);
	var router_1 = __webpack_require__(223);
	var d3 = __webpack_require__(270);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d3 = __webpack_require__(270);
	var Roles = (function () {
	    function Roles(app, matchListService, routeParam) {
	        var _this = this;
	        this.app = app;
	        this.matchListService = matchListService;
	        this.routeParam = routeParam;
	    ...
	    Roles.prototype.loadRoles = function () {
	        var _this = this;
	        ...
	        Object.keys(this.app.rankedMatchesList.matchesByRole)
	            ...
	            _this.roles.push({
	                role: role,
	                timesPlayed: _this.app.rankedMatchesList.matchesByRole[role]
	            });
	        });
	    ...
	    Roles.prototype.drawChart = function () {
	        var x = d3.scale.linear()
	            .domain([0, d3.max(this.roles.map(function (c) { return c.timesPlayed; }))])
	            .range([0, 50]);
	        d3.select(".chart").html("");
